        ...
        let uploader = new AliyunUpload.Vod({
          ...
          onUploadstarted: function (uploadInfo) {
            ...
            if (!uploadInfo.videoId) {
              let createUrl = 'http://localhost:3000/api/v1/video/getvod'
              axios.get(createUrl).then(({data}) => {
                let newData = data.vod
                let uploadAuth = newData.UploadAuth
                let uploadAddress = newData.UploadAddress
                let videoId = newData.VideoId
